package software.idie.fragmentnavigation.widget;
    ...
    private void selectChild(View child, boolean select) {
        if (child instanceof ViewGroup) {
            ...
            if (child instanceof ImageView) {
                ...
                if (select) {
                    drawable.setColorFilter(getResources().getColor(R.color.md_amber_300), PorterDuff.Mode.SRC_ATOP);
                } else {
                    drawable.setColorFilter(getResources().getColor(R.color.md_blue_300), PorterDuff.Mode.SRC_ATOP);
                }
            }
        }
    }
